...
export type EventSubtype = keyof typeof EventSubtypeEnum;

export const toEventSubtype = (str: string): EventSubtype | undefined => {
    return Object.keys(EventSubtypeEnum).includes(str) ? (Object(EventSubtypeEnum))[str] : undefined;
};

export const displayEventSubtype = (eventSubtype: EventSubtype): string => {
    return String(eventSubtype).replaceAll("_", " ");
};
